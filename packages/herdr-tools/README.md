...
a full commit ID, and a clean attached or detached checkout. The confirmation
shows the checkout, branch or detached state, old HEAD, target commit, and command. State and root registration
