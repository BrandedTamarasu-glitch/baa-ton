...
# both `Die` and the cancel path can use `throw`/`return` to stop early
# without ever calling `exit` (see the comment on `Die` above).
function Invoke-BaaTonInstall {
